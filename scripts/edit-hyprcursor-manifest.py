...
def main():
    ...
    with open(metahl, "r+") as f:
        ...
        if theme_name.endswith("-Classic"):
            ...
            desc += "Rosepine and " + shape + " Bibata cursors"
        elif theme_name.endswith("-Gruvbox-Dark"):
            desc += "Gruvbox dark and " + shape + " Bibata cursors"
        for line in content:
            if not line.startswith("name = Extracted Theme") and not line.startswith(
